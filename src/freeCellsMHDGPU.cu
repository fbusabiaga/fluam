...
bool freeCellsMHDGPU(){
  ...
  cutilSafeCall(cudaFree(bxGPU));
  cutilSafeCall(cudaFree(byGPU));
  cutilSafeCall(cudaFree(bzGPU));
  cutilSafeCall(cudaFree(bxPredictionGPU));
  cutilSafeCall(cudaFree(byPredictionGPU));
