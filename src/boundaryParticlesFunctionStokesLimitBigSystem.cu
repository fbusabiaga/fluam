...
void boundaryParticlesFunctionStokesLimitBigSystem(int option,
  ...
  if(option==0){
	...
	(pc, 
	 errorKernel);
      ...
      kernelSpreadParticlesForceStokesLimitBigSystem<<<numBlocksParticles,threadsPerBlockParticles>>>
	(rxcellGPU,
	 rycellGPU,
	 rzcellGPU,
	 fxboundaryGPU,
	 ...
	 pNeighbors);
      ...
      addSpreadedForcesStokesLimitBigSystem<<<numBlocks,threadsPerBlock>>>(vxGPU, //Stored fx=S*Fx
									   vyGPU,
									   vzGPU,
									   fxboundaryGPU,
									   fyboundaryGPU,
    ...
    updateParticlesStokesLimitBigSystem_1<<<numBlocksParticles,threadsPerBlockParticles>>>
      (pc, 
       errorKernel,
       rxcellGPU,
       rycellGPU,
    ...
    kernelSpreadParticlesDriftBigSystem<<<numBlocksParticles,threadsPerBlockParticles>>>(rxcellGPU,
											 rycellGPU,
											 rzcellGPU,
											 fxboundaryGPU,
											 fyboundaryGPU,
    ...
    addSpreadedForcesStokesLimitBigSystem<<<numBlocks,threadsPerBlock>>>(vxGPU, //Stored fx=S*Fx+S*drift_p
									 vyGPU,
									 vzGPU,
									 fxboundaryGPU,
									 fyboundaryGPU,
    ...
    //Add drift spreaded by the particles
    addSpreadedForcesStokesLimitBigSystem<<<numBlocks,threadsPerBlock>>>(vxGPU, //Stored fx=S*Fx+S*drift_p-S*drift_m
									 vyGPU,
									 vzGPU,
									 fxboundaryGPU,
									 fyboundaryGPU,
    ...
    if(setparticles){
      ...
      updateParticlesStokesLimitBigSystem_2<<<numBlocksParticles,threadsPerBlockParticles>>>
	(rxcellGPU,
	 rycellGPU,
	 rzcellGPU,
	 rxboundaryGPU,  //q^{n}
