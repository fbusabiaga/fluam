...
bool initializeBondedForcesOldVersion(){
  ...
  // In the new version the bonds between particles
  // are counted only once per bond, therefore we
  // need to divede the number of bonds by 2.
  nbondsParticleParticle /= 2;
