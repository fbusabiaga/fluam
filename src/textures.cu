...
void initTextures(){
  ...
  cudaBindTexture(0,texvecino0GPU,vecino0GPU,ncells*sizeof(int));
  //texvecino1GPU
  ...
  cudaBindTexture(0,texvecino1GPU,vecino1GPU,ncells*sizeof(int));
  //texvecino2GPU
  ...
  cudaBindTexture(0,texvecino2GPU,vecino2GPU,ncells*sizeof(int));
  //texvecino3GPU
  ...
  cudaBindTexture(0,texvecino3GPU,vecino3GPU,ncells*sizeof(int));
  //texvecino4GPU
  ...
  cudaBindTexture(0,texvecino4GPU,vecino4GPU,ncells*sizeof(int));
  //texvecino5GPU
  ...
  cudaBindTexture(0,texvecino5GPU,vecino5GPU,ncells*sizeof(int));
  //texvecinopxpyGPU
  ...
  cudaBindTexture(0,texvecinopxpyGPU,vecinopxpyGPU,ncells*sizeof(int));
  //texvecinopxmyGPU
  ...
  cudaBindTexture(0,texvecinopxmyGPU,vecinopxmyGPU,ncells*sizeof(int));
  //texvecinopxpzGPU
  ...
  cudaBindTexture(0,texvecinopxpzGPU,vecinopxpzGPU,ncells*sizeof(int));
  //texvecinopxmzGPU
  ...
  cudaBindTexture(0,texvecinopxmzGPU,vecinopxmzGPU,ncells*sizeof(int));
  //texvecinomxpyGPU
  ...
  cudaBindTexture(0,texvecinomxpyGPU,vecinomxpyGPU,ncells*sizeof(int));
  //texvecinomxmyGPU
  ...
  cudaBindTexture(0,texvecinomxmyGPU,vecinomxmyGPU,ncells*sizeof(int));
  //texvecinomxpzGPU
  ...
  cudaBindTexture(0,texvecinomxpzGPU,vecinomxpzGPU,ncells*sizeof(int));
  //texvecinomxmzGPU
  ...
  cudaBindTexture(0,texvecinomxmzGPU,vecinomxmzGPU,ncells*sizeof(int));
  //texvecinopypzGPU
  ...
  cudaBindTexture(0,texvecinopypzGPU,vecinopypzGPU,ncells*sizeof(int));
  //texvecinopymzGPU
  ...
  cudaBindTexture(0,texvecinopymzGPU,vecinopymzGPU,ncells*sizeof(int));
  //texvecinomypzGPU
  ...
  cudaBindTexture(0,texvecinomypzGPU,vecinomypzGPU,ncells*sizeof(int));
  //texvecinomymzGPU
  ...
  cudaBindTexture(0,texvecinomymzGPU,vecinomymzGPU,ncells*sizeof(int));
  //texvecinopxpypzGPU
  ...
  cudaBindTexture(0,texvecinopxpypzGPU,vecinopxpypzGPU,ncells*sizeof(int));
  //texvecinopxpymzGPU
  ...
  cudaBindTexture(0,texvecinopxpymzGPU,vecinopxpymzGPU,ncells*sizeof(int));
  //texvecinopxmypzGPU
  ...
  cudaBindTexture(0,texvecinopxmypzGPU,vecinopxmypzGPU,ncells*sizeof(int));
  //texvecinopxmymzGPU
  ...
  cudaBindTexture(0,texvecinopxmymzGPU,vecinopxmymzGPU,ncells*sizeof(int));
  //texvecinomxpypzGPU
  ...
  cudaBindTexture(0,texvecinomxpypzGPU,vecinomxpypzGPU,ncells*sizeof(int));
  //texvecinomymzGPU
  ...
  cudaBindTexture(0,texvecinomxpymzGPU,vecinomxpymzGPU,ncells*sizeof(int));
  //texvecinomxmypzGPU
  ...
  cudaBindTexture(0,texvecinomxmypzGPU,vecinomxmypzGPU,ncells*sizeof(int));
  //texvecinomxmymzGPU
  ...
  cudaBindTexture(0,texvecinomxmymzGPU,vecinomxmymzGPU,ncells*sizeof(int));
  ...
  if(setparticles==1){
    ...
    cudaBindTexture(0,texCountParticlesInCellNonBonded,countPartInCellNonBonded,numNeighbors*sizeof(int));
