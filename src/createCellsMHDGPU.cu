...
bool createCellsMHDGPU(){
  ...
  cutilSafeCall(cudaMalloc((void**)&bxGPU,ncells*sizeof(double)));
  cutilSafeCall(cudaMalloc((void**)&byGPU,ncells*sizeof(double)));
  cutilSafeCall(cudaMalloc((void**)&bzGPU,ncells*sizeof(double)));
  cutilSafeCall(cudaMalloc((void**)&bxPredictionGPU,ncells*sizeof(double)));
  cutilSafeCall(cudaMalloc((void**)&byPredictionGPU,ncells*sizeof(double)));
