...
bool createBoundariesGPU(){
  ...
  cudaMemcpyToSymbol(particlesWallGPU,&particlesWall,sizeof(bool));
  ...
  cudaMalloc((void**)&countparticlesincellX,ncellst*sizeof(int));
  cudaMalloc((void**)&countparticlesincellY,ncellst*sizeof(int));
  cudaMalloc((void**)&countparticlesincellZ,ncellst*sizeof(int));
  int aux[ncellst];
  ...
  cudaBindTexture(0,texCountParticlesInCellX,countparticlesincellX,ncellst*sizeof(int));
  ...
  cudaBindTexture(0,texCountParticlesInCellY,countparticlesincellY,ncellst*sizeof(int));
  ...
  cudaBindTexture(0,texCountParticlesInCellZ,countparticlesincellZ,ncellst*sizeof(int));
  //texPartInCellX;
  ...
  cudaBindTexture(0,texPartInCellX,partincellX,maxNumberPartInCell*ncellst*sizeof(int));
  //texPartInCellY;
  ...
  cudaBindTexture(0,texPartInCellY,partincellY,maxNumberPartInCell*ncellst*sizeof(int));
  //texPartInCellZ;
  ...
  cudaBindTexture(0,texPartInCellZ,partincellZ,maxNumberPartInCell*ncellst*sizeof(int));
  ...
  if(setparticles){
    ...
    cudaBindTexture(0,texCountParticlesInCellNonBonded,countPartInCellNonBonded,
