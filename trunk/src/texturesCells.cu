...
bool texturesCells(){
  ...
  cudaBindTexture(0,texvecino0GPU,vecino0GPU,ncellst*sizeof(int));
  //texvecino1GPU
  ...
  cudaBindTexture(0,texvecino1GPU,vecino1GPU,ncellst*sizeof(int));
  //texvecino2GPU
  ...
  cudaBindTexture(0,texvecino2GPU,vecino2GPU,ncellst*sizeof(int));
  //texvecino3GPU
  ...
  cudaBindTexture(0,texvecino3GPU,vecino3GPU,ncellst*sizeof(int));
  //texvecino4GPU
  ...
  cudaBindTexture(0,texvecino4GPU,vecino4GPU,ncellst*sizeof(int));
  //texvecino5GPU
  ...
  cudaBindTexture(0,texvecino5GPU,vecino5GPU,ncellst*sizeof(int));
  //texvecinopxpyGPU
  ...
  cudaBindTexture(0,texvecinopxpyGPU,vecinopxpyGPU,ncellst*sizeof(int));
  //texvecinopxmyGPU
  ...
  cudaBindTexture(0,texvecinopxmyGPU,vecinopxmyGPU,ncellst*sizeof(int));
  //texvecinopxpzGPU
  ...
  cudaBindTexture(0,texvecinopxpzGPU,vecinopxpzGPU,ncellst*sizeof(int));
  //texvecinopxmzGPU
  ...
  cudaBindTexture(0,texvecinopxmzGPU,vecinopxmzGPU,ncellst*sizeof(int));
  //texvecinomxpyGPU
  ...
  cudaBindTexture(0,texvecinomxpyGPU,vecinomxpyGPU,ncellst*sizeof(int));
  //texvecinomxmyGPU
  ...
  cudaBindTexture(0,texvecinomxmyGPU,vecinomxmyGPU,ncellst*sizeof(int));
  //texvecinomxpzGPU
  ...
  cudaBindTexture(0,texvecinomxpzGPU,vecinomxpzGPU,ncellst*sizeof(int));
  //texvecinomxmzGPU
  ...
  cudaBindTexture(0,texvecinomxmzGPU,vecinomxmzGPU,ncellst*sizeof(int));
  //texvecinopypzGPU
  ...
  cudaBindTexture(0,texvecinopypzGPU,vecinopypzGPU,ncellst*sizeof(int));
  //texvecinopymzGPU
  ...
  cudaBindTexture(0,texvecinopymzGPU,vecinopymzGPU,ncellst*sizeof(int));
  //texvecinomypzGPU
  ...
  cudaBindTexture(0,texvecinomypzGPU,vecinomypzGPU,ncellst*sizeof(int));
  //texvecinomymzGPU
  ...
  cudaBindTexture(0,texvecinomymzGPU,vecinomymzGPU,ncellst*sizeof(int));
  //texvecinopxpypzGPU
  ...
  cudaBindTexture(0,texvecinopxpypzGPU,vecinopxpypzGPU,ncellst*sizeof(int));
  //texvecinopxpymzGPU
  ...
  cudaBindTexture(0,texvecinopxpymzGPU,vecinopxpymzGPU,ncellst*sizeof(int));
  //texvecinopxmypzGPU
  ...
  cudaBindTexture(0,texvecinopxmypzGPU,vecinopxmypzGPU,ncellst*sizeof(int));
  //texvecinopxmymzGPU
  ...
  cudaBindTexture(0,texvecinopxmymzGPU,vecinopxmymzGPU,ncellst*sizeof(int));
  //texvecinomxpypzGPU
  ...
  cudaBindTexture(0,texvecinomxpypzGPU,vecinomxpypzGPU,ncellst*sizeof(int));
  //texvecinomymzGPU
  ...
  cudaBindTexture(0,texvecinomxpymzGPU,vecinomxpymzGPU,ncellst*sizeof(int));
  //texvecinomxmypzGPU
  ...
  cudaBindTexture(0,texvecinomxmypzGPU,vecinomxmypzGPU,ncellst*sizeof(int));
  //texvecinomxmymzGPU
  ...
  cudaBindTexture(0,texvecinomxmymzGPU,vecinomxmymzGPU,ncellst*sizeof(int));
